...
describe('Iva Management Component', () => {
  let comp: IvaComponent;
  let fixture: ComponentFixture<IvaComponent>;
  let service: IvaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'iva', component: IvaComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ivas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
