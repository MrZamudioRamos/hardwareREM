...
describe('Componente Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'componente', component: ComponenteComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.componentes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
