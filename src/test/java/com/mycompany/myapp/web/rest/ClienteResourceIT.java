...
class ClienteResourceIT {
    ...
    private static final Boolean DEFAULT_FIDELIZADO = false;
    private static final Boolean UPDATED_FIDELIZADO = true;
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getFidelizado()).isEqualTo(DEFAULT_FIDELIZADO);
    ...
    @Test
    @Transactional
    void checkFidelizadoIsRequired() throws Exception {
        int databaseSizeBeforeTest = clienteRepository.findAll().size();
        // set the field null
    ...
    void getAllClientes() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.[*].fidelizado").value(hasItem(DEFAULT_FIDELIZADO.booleanValue())))
    ...
    void getCliente() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.fidelizado").value(DEFAULT_FIDELIZADO.booleanValue()))
    ...
    void putNewCliente() throws Exception {
        ...
        assertThat(testCliente.getFidelizado()).isEqualTo(UPDATED_FIDELIZADO);
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.apellidos(UPDATED_APELLIDOS).fidelizado(UPDATED_FIDELIZADO).activo(UPDATED_ACTIVO);
